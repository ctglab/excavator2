...
RUN /opt/conda/envs/excavator2/bin/R CMD SHLIB /opt/excavator2/lib/F77/F4R.f && \
    /opt/conda/envs/excavator2/bin/R CMD SHLIB /opt/excavator2/lib/F77/FastJointSLMLibraryI.f 
